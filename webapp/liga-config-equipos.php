...
if (isset($_GET['action'])) {
  if ($_GET['action'] == "nuevoEquipo") {
    ...
    $idEquipo   = $_GET['id'];
    // Establecer una variable de sesi�n con el ID del equipo a editar
    ...
    // Borrar la variable de sesi�n que guarda el ID del equipo a editar
...
// Presentar el formulario de creaci�n de equipos
echo "
    <div id=\"navcontainer\">
      <ul id=\"navlist\">
